...
class ItemsResponseTest {
  ...
  void testItemsResponseConstructorAndGetters() {
    ItemResponse item1 = new ItemResponse(1, "Laptop", "Alice", "A gaming laptop", "2024-03-15", 1500);
    ItemResponse item2 = new ItemResponse(2, "Phone", "Bob", "A smartphone", "2024-03-16", 800);
  ...
  @Test
  void testSetItems() {
    ItemResponse item1 = new ItemResponse(1, "Tablet", "Charlie", "A new tablet", "2024-03-17", 600);
